...
def factorielle(n):
    ...
    rôle : Calcule la factorielle de n
    """
    facto = 1
...
def epreuve_math_factorielle():
    ...
    entre 1 et 10 et sort Vrai si le joueur a raison et Faux s'il n'a pas la bonne réponse
    """
...
def est_premier(reponse):
    ...
    Parametre : entier
    sortie : Booléen
    role : Cela vérifie que le nombre est premier donc renvoie True s'il l'est ou False s'il ne l'est pas.
    Cela vérifie également qu'il ne soit pas inférieur ou égal à 1
